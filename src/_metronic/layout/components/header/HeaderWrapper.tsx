...
export function HeaderWrapper() {
    ...
    return (
        <div
            id='kt_header'
            className={clsx('header', classes.header.join(' '), 'align-items-stretch bg-[#008CCB]')}
            data-kt-sticky='true'
                ...
                <div className='header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0'>
                    <Link to='/'>
                        <img
                            ...
                            className='logo-default object-fit-cover h-45px h-md-60px w-80px w-md-100px'
                        />
                        <img
                            alt='Logo'
                            src={toAbsoluteUrl('media/logos/logo.png')}
                            className='logo-sticky object-fit-cover h-60px w-90px'
                        />
                    </Link>
                </div>
